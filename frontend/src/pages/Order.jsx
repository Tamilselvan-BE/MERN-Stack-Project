...
const Order = () => {
  ...
  return (
    <section className='max-padd-container py-28 xl:py-32'>
      <from onSubmit={placeOrder} className='flex flex-col xl:flex-row gap-20 xl:gap-28'>
        <div className='flex flex-1 flex-col gap-3 text-[95%]'>
          ...
          <div className='flex gap-3'>
            ...
            <input required onChange={onChangeHandler} name="email" value={data.email} type="email" placeholder='Email name' className='ring-1 ring-slate-900/15 p-1 pl-3 rounded-sm outline-none'/>
          ...
          <div className='flex flex-col flex-1'>
              <div className='flex flex-col gap-2'>
                ...
                <button type="submit"className='btn-secondary w-52 rounded'>Product to Checkout</button>
              </div>
