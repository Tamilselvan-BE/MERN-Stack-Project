          ...
          <tbody>
            ...
            <div className='flex flex-col xl:flex-row gap-20 mt-20'>
              <div className='flex flex-1 flex-col gap-2'>
                ...
                <button onClick={()=> navigate('/order')} className='btn-secondary w-52 rounded'>Product to Checkout</button>
              </div>
              <div className='flex flex-1 flex-col gap-8'>
                <h4 className='bold-20 capitlalize'>Your coupon code enter here:</h4>
                <div className='flexBetween h-[2.8rem] bg-primary ring-1 ring-slate-900/10 w-full max-w-[488px] rounded'>
                  <input type="text" placeholder='Coupon Code' className='pl-3 bg-transprent border-none outline-none'/>
